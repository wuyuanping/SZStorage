...
#import "SZInputWhiteController.h"

@interface SZInputColorController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation SZInputColorController
...
{
    //红色
    SZInputRedController *redVC = [[SZInputRedController alloc] init];
    redVC.title = @"红色";
    [self addChildViewController:redVC];
    
    //白色
    SZInputWhiteController *whiteVC = [[SZInputWhiteController alloc] init];
    whiteVC.title = @"白色";
...
- (void)setupBottomContainerView
{
    ...
    flow.itemSize = CGSizeMake(SCREEN_W, 89);
...
- (void)setupTopTitleView
{
    ...
    [self.topBtnView addSubview:scrollView];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView  cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    vc.view.frame = CGRectMake(0, 0, SCREEN_W, 89);
